...
class ReportController extends Controller
{
    ...
    public function index(Request $request): JsonResponse
    {
        ...
        $pakasirFee = $this->payments($period)->where('status', 'paid')->where('is_simulated', false)->sum('provider_fee');
        $netRevenue = $this->payments($period)->where('status', 'paid')->where('is_simulated', false)->sum('net_amount');
