...
use App\Filament\SuperAdmin\Resources\GlobalSessionResource\Pages;
...
class GlobalSessionResource extends Resource
{
    ...
    public static function getPluralModelLabel(): string { return 'Semua Sesi Foto'; }
    ...
    {
        return $schema->components([
            Section::make('Informasi Sesi & Lokasi')->schema([
                TextEntry::make('id')->label('ID Sesi'),
                TextEntry::make('cafe.name')->label('Lokasi Cafe')->badge()->color('primary')->placeholder('-'),
    ...
    public static function table(Table $table): Table
    {
        return $table
            ->columns([
                ...
                TextColumn::make('cafe.name')->label('Cafe')->badge()->color('primary')->searchable()->sortable(),
    ...
    {
        return [
            'index' => Pages\ListGlobalSessions::route('/'),
            'view'  => Pages\ViewGlobalSession::route('/{record}'),
        ];
    }
}
