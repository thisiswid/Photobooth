...
| [08 — POC Camera Remote Command](08-camera-remote-command-poc.md) | **ZV-E10 ternyata DIDUKUNG Camera Remote Command** (beda dari SDK). Temuan pra-coding, rencana POC, status BLOCKED |
